...
[![CI](https://github.com/JAGHDHEEP/heart-disease-risk-prediction/actions/workflows/ci.yml/badge.svg)](https://github.com/JAGHDHEEP/heart-disease-risk-prediction/actions/workflows/ci.yml)
...
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://share.streamlit.io/deploy?repository=JAGHDHEEP%2Fheart-disease-risk-prediction&branch=main&mainModule=app%2Fstreamlit_app.py)

**🔗 Live Demo:** https://heart-disease-risk-prediction.streamlit.app &nbsp;·&nbsp; **📖 API Docs:** run `uvicorn api.main:app` → `/docs`
...
**▶️ Try it live:** **https://heart-disease-risk-prediction.streamlit.app**

[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://share.streamlit.io/deploy?repository=JAGHDHEEP%2Fheart-disease-risk-prediction&branch=main&mainModule=app%2Fstreamlit_app.py)

| Interface | How to run | URL |
| --- | --- | --- |
| 🖥️ **Streamlit app** (demo) | `streamlit run app/streamlit_app.py` | [Live ↗](https://heart-disease-risk-prediction.streamlit.app) / `localhost:8501` |
| ⚡ **FastAPI service** (REST) | `uvicorn api.main:app` | `localhost:8000/docs` |
| 🐳 **Both, via Docker** | `docker compose up --build` | `:8501` + `:8000` |

> The app boots in seconds and has been verified to run cleanly (HTTP 200) before
> deployment. One-click deploy via the badge above (free Streamlit Community Cloud).

---

## 📸 Screenshots

The model-evaluation visuals below are committed and render directly. To add UI
captures of the running app, drop `streamlit_result.png` and `api_docs.png` into
`docs/img/` and uncomment the table in this section (guide in
[`docs/SCREENSHOTS.md`](docs/SCREENSHOTS.md)).

<!-- App UI screenshots — uncomment after adding the PNGs to docs/img/
| Streamlit — prediction + SHAP | FastAPI — Swagger docs |
| --- | --- |
| ![Streamlit app](docs/img/streamlit_result.png) | ![API docs](docs/img/api_docs.png) |
-->

**Model evaluation (auto-generated by `python -m heart.train`):**

| ROC Curve | Confusion Matrix | Feature Importance |
| --- | --- | --- |
| ![ROC](reports/roc_curve.png) | ![Confusion Matrix](reports/confusion_matrix.png) | ![Feature Importance](reports/feature_importance.png) |
...
> 📊 ROC curve, confusion matrix and feature-importance plots are in the
